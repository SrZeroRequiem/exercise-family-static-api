...
def test_delete_response(client):
    response = client.delete('/members/3444')
    assert response.json["msg"] == "Member 3444 deleted"

@pytest.mark.it("After deleting the member 3443 we called GET /members and it should return a list with 3 members")
